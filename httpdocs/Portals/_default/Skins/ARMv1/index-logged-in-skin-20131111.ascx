...
<dnn:DnnJsInclude ID="bootstrapInclude" runat="server" FilePath="js/bootstrap.js" PathNameAlias="SkinPath" />
...
<dnn:STYLES runat="server" ID="Lato" Name="Lato" StyleSheet="http://fonts.googleapis.com/css?family=Lato:300,400,700" UseSkinPath="false" />
...
<div id="siteWrapper">
    ...
    <div id="wrap">
        ...
        <!-- Recruitment tab -->
        <!-- HEY JACKASS - make this a layout pane -->
